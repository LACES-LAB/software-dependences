...
source /lore/mersoj/laces-software/scripts/loads.sh
# UPDATE TO YOUR OWN DIRECTORY
SOURCE_DIR="${SOURCE_DIR:-/lore/mersoj/laces-software/sources}"
# UPDATE TO YOUR OWN DIRECTORY
BUILD_DIR="${BUILD_DIR:-/lore/mersoj/laces-software/build}"

# LEAVE THESE ALONE (for now)
DEVICE_ARCH="${DEVICE_ARCH:-TURING75}"
DEPENDENCY_DIR="${DEPENDENCY_DIR:-/lore/mersoj/laces-software/build/}"
...
cmake -S $SOURCE_DIR/pcms -B $BUILD_DIR/${DEVICE_ARCH}/pcms \
  ...
  -DCMAKE_Fortran_COMPILER=`which mpifort`\
	...
	-DWDMCPL_TEST_DATA_DIR=$SOURCE_DIR/pcms_testcases \
